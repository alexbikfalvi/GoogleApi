...
namespace Google.YouTube {
    ...
    /// <summary>
	/// The Video Entry in feed&lt;Videos&gt; for YouTube.
    /// </summary> 
    ...
    public class YouTubeRequest : FeedRequest<YouTubeService> {
        ...
        /// </summary>
        /// <returns>A feed of activities.</returns>
        ...
        /// </summary>
        /// <example>
        ///		The following code illustrates a possible use of the <c>GetPlaylist</c> method:  
        ///     <code>    
        ...
        ///		</code>
        /// </example>
        /// <param name="p">The playlist for which to get the videos.</param>
        /// <returns>A feed of playlists.</returns>
