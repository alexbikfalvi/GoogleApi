...
namespace Google.Apis.Oauth2.v2 {
    ...
    public partial class Oauth2Service : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"etag\":\"\\\"a3GBuXuTtUYW9BV1SIieU5LiL7w/Pu7-Vm8" +
            "xmZRzhWO0Ba2Ui4bG58E\\\"\",\"discoveryVersion\":\"v1\",\"id\":\"oauth2:v2\",\"name\":\"oauth2\"" +
            ",\"version\":\"v2\",\"revision\":\"20120806\",\"title\":\"Google OAuth2 API\",\"description\":" +
            ...
            "iption\":\"The user\'s first name.\"},\"id\":{\"type\":\"string\",\"description\":\"The focus" +
            " obfuscated gaia id of the user.\"},\"link\":{\"type\":\"string\",\"description\":\"URL of" +
            " the profile page.\"},\"locale\":{\"type\":\"string\",\"description\":\"The user\'s default" +
            " locale.\"},\"name\":{\"type\":\"string\",\"description\":\"The user\'s full name.\"},\"pictu" +
            "re\":{\"type\":\"string\",\"description\":\"URL of the user\'s picture image.\"},\"timezone" +
            "\":{\"type\":\"string\",\"description\":\"The user\'s default timezone.\"},\"verified_email" +
            "\":{\"type\":\"boolean\",\"description\":\"Boolean flag which is true if the email addre" +
            "ss is verified.\"}}}},\"methods\":{\"tokeninfo\":{\"id\":\"oauth2.tokeninfo\",\"path\":\"oau" +
            "th2/v2/tokeninfo\",\"httpMethod\":\"POST\",\"parameters\":{\"access_token\":{\"type\":\"stri" +
            "ng\",\"location\":\"query\"},\"id_token\":{\"type\":\"string\",\"location\":\"query\"}},\"respon" +
            "se\":{\"$ref\":\"Tokeninfo\"}}},\"resources\":{\"userinfo\":{\"methods\":{\"get\":{\"id\":\"oaut" +
            "h2.userinfo.get\",\"path\":\"oauth2/v2/userinfo\",\"httpMethod\":\"GET\",\"response\":{\"$re" +
            "f\":\"Userinfo\"},\"scopes\":[\"https://www.googleapis.com/auth/plus.me\",\"https://www." +
            "googleapis.com/auth/userinfo.email\",\"https://www.googleapis.com/auth/userinfo.pr" +
            "ofile\"]}},\"resources\":{\"v2\":{\"resources\":{\"me\":{\"methods\":{\"get\":{\"id\":\"oauth2.u" +
            "serinfo.v2.me.get\",\"path\":\"userinfo/v2/me\",\"httpMethod\":\"GET\",\"response\":{\"$ref\"" +
