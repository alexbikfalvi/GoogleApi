...
namespace Google.Apis.Shopping.v1 {
    ...
    public partial class ShoppingService : Google.Apis.Discovery.IRequestProvider {
        ...
        private const string DiscoveryDocument = "{\"kind\":\"discovery#restDescription\",\"etag\":\"\\\"a3GBuXuTtUYW9BV1SIieU5LiL7w/fkGa4jJ" +
            "B_jGfibeN9C5BItCQTOc\\\"\",\"discoveryVersion\":\"v1\",\"id\":\"shopping:v1\",\"name\":\"shopp" +
            "ing\",\"version\":\"v1\",\"revision\":\"20121026\",\"title\":\"Search API For Shopping\",\"des" +
            ...
            "ion\":\"query\"},\"facets.includeEmptyBuckets\":{\"type\":\"boolean\",\"description\":\"Retu" +
            "rn empty facet buckets.\",\"location\":\"query\"},\"facets.useGcsConfig\":{\"type\":\"bool" +
            "ean\",\"description\":\"Whether to return facet information as configured in the GCS" +
            " account\",\"location\":\"query\"},\"language\":{\"type\":\"string\",\"description\":\"Languag" +
            "e restriction (BCP 47)\",\"location\":\"query\"},\"location\":{\"type\":\"string\",\"descrip" +
            "tion\":\"Location used to determine tax and shipping\",\"location\":\"query\"},\"maxResu" +
            "lts\":{\"type\":\"integer\",\"description\":\"Maximum number of results to return\",\"form" +
            "at\":\"uint32\",\"location\":\"query\"},\"maxVariants\":{\"type\":\"integer\",\"description\":\"" +
            "Maximum number of variant results to return per result\",\"format\":\"int32\",\"locati" +
            "on\":\"query\"},\"plusOne.enabled\":{\"type\":\"boolean\",\"description\":\"Whether to retur" +
            "n +1 button code\",\"location\":\"query\"},\"plusOne.styles\":{\"type\":\"string\",\"descrip" +
            "tion\":\"+1 button rendering styles\",\"location\":\"query\"},\"plusOne.useGcsConfig\":{\"" +
            "type\":\"boolean\",\"description\":\"Whether to use +1 button styles configured in the" +
            " GCS account\",\"location\":\"query\"},\"promotions.enabled\":{\"type\":\"boolean\",\"descri" +
            "ption\":\"Whether to return promotion information\",\"location\":\"query\"},\"promotions" +
            ".useGcsConfig\":{\"type\":\"boolean\",\"description\":\"Whether to return promotion info" +
            "rmation as configured in the GCS account\",\"location\":\"query\"},\"q\":{\"type\":\"strin" +
            "g\",\"description\":\"Search query\",\"location\":\"query\"},\"rankBy\":{\"type\":\"string\",\"d" +
            "escription\":\"Ranking specification\",\"location\":\"query\"},\"redirects.enabled\":{\"ty" +
            "pe\":\"boolean\",\"description\":\"Whether to return redirect information\",\"location\":" +
            "\"query\"},\"redirects.useGcsConfig\":{\"type\":\"boolean\",\"description\":\"Whether to re" +
            "turn redirect information as configured in the GCS account\",\"location\":\"query\"}," +
            "\"relatedQueries.enabled\":{\"type\":\"boolean\",\"description\":\"Whether to return rela" +
            "ted queries\",\"location\":\"query\"},\"relatedQueries.useGcsConfig\":{\"type\":\"boolean\"" +
            ",\"description\":\"This parameter is currently ignored\",\"location\":\"query\"},\"restri" +
            "ctBy\":{\"type\":\"string\",\"description\":\"Restriction specification\",\"location\":\"que" +
            "ry\"},\"safe\":{\"type\":\"boolean\",\"description\":\"Whether safe search is enabled. Def" +
            "ault: true\",\"location\":\"query\"},\"source\":{\"type\":\"string\",\"description\":\"Query s" +
            "ource\",\"required\":true,\"location\":\"path\"},\"spelling.enabled\":{\"type\":\"boolean\",\"" +
            "description\":\"Whether to return spelling suggestions\",\"location\":\"query\"},\"spell" +
            "ing.useGcsConfig\":{\"type\":\"boolean\",\"description\":\"This parameter is currently i" +
            "gnored\",\"location\":\"query\"},\"startIndex\":{\"type\":\"integer\",\"description\":\"Index " +
            "(1-based) of first product to return\",\"format\":\"uint32\",\"location\":\"query\"},\"tax" +
            "onomy\":{\"type\":\"string\",\"description\":\"Taxonomy name\",\"location\":\"query\"},\"thumb" +
            "nails\":{\"type\":\"string\",\"description\":\"Image thumbnails specification\",\"location" +
            "\":\"query\"},\"useCase\":{\"type\":\"string\",\"description\":\"One of CommerceSearchUseCas" +
            "e, ShoppingApiUseCase\",\"location\":\"query\"}},\"parameterOrder\":[\"source\"],\"respons" +
            "e\":{\"$ref\":\"Products\"},\"scopes\":[\"https://www.googleapis.com/auth/shoppingapi\"]}" +
            "}}}}";
