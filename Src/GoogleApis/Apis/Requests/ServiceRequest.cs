...
namespace Google.Apis.Requests
{
    ...
    public abstract class ServiceRequest<TResponse> : IServiceRequest<TResponse>
    {
        ...
        {
            RequestAsyncResult asyncResult = new RequestAsyncResult();
                ...
                result =>
                    {
                        ...
                        {
                            // Fetch the result.
                            asyncResult.Result = fetchFunction(result);
                        }
        ...
        internal object EndFetchInternal(IAsyncResult asyncResult)
        {
			...
			// If an exception occurred during the asynchronous operation, throw the exception.
